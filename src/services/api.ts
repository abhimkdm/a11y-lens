...
export const api = {
  ...
  crawlStart: (opts: {
    ...
    confinePath?: boolean; skipChrome?: boolean; seedUrls?: string[]; collapseTemplates?: boolean;
    routeTemplates?: string[]; routeVars?: Record<string, string>; autoHarvest?: boolean;
  }) =>
